...
public class DiscussionManager : MonoBehaviour {
	...
	public void AddConvincingDiscussions(string farmTypeString, Neighbor neighbor) {
		if(neighbor == gameManager.neighborList[0]) { //Leon
			...
			new List<Response> {
				new Response(ResponseType.Environment, "You thank Gerald for his improved energy habits. With a " + farmTypeString + " we can change everyone’s habits. Producing green energy will reduce our use of fossil fuels.", "Hmph. You always gotta be right, huh? Alright, alright I'll help pay for the thing. But this is the last thing I'm doing, I swear! Anyways, I've appreciated your help, youngster.", true),
